...
class ComputeGyroVar:
  ...
  def main(self):
    ...
    for i in range(no_of_samples):
      r_rate, p_rate, y_rate = g.serClient.get(g.GYR_CAL_COMM_ADDRESS)
    ...
    g.serClient.send(g.GYR_VAR_COMM_ADDRESS, roll_rate_variance, pitch_rate_variance, yaw_rate_variance)
    roll_rate_variance, pitch_rate_variance, yaw_rate_variance = g.serClient.get(g.GYR_VAR_COMM_ADDRESS)
