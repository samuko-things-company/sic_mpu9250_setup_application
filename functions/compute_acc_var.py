...
class ComputeAccVar:
  ...
  def main(self):
    ...
    for i in range(no_of_samples):
      ...
      lin_accx, lin_accy, lin_accz = g.serClient.get(g.ACC_CAL_COMM_ADDRESS)
    ...
    g.serClient.send(g.ACC_VAR_COMM_ADDRESS, lin_accx_variance, lin_accy_variance, lin_accz_variance)
    lin_accx_variance, lin_accy_variance, lin_accz_variance = g.serClient.get(g.ACC_VAR_COMM_ADDRESS)
